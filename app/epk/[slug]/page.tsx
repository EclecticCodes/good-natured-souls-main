  ...
  return (
    <div id="epk-root" style={{ background: "#080808", color: "#fff", minHeight: "100vh", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <style>{`
        ...
        .epk-section-label {
          font-size: 9px; letter-spacing: 4px; color: #F0B51E;
          text-transform: uppercase; font-weight: 700; margin: 0 0 20px; display: block;
        }
        .epk-divider {
          border-top: 1px solid #1e1e1e; margin-bottom: 48px; padding-top: 48px;
        }
        a { color: inherit; }
        @media (max-width: 640px) {
          .epk-hero { flex-direction: column !important; gap: 24px !important; }
          .epk-hero-photo { width: 120px !important; height: 120px !important; }
          .epk-hero-name { font-size: 36px !important; letter-spacing: -1px !important; }
          .epk-nav { padding: 12px 16px !important; }
          .epk-nav-label { display: none !important; }
          .epk-nav-divider { display: none !important; }
          .epk-hero-pad { padding: 32px 20px 28px !important; }
          .epk-main-pad { padding: 32px 20px 60px !important; }
          .epk-contact-grid { grid-template-columns: 1fr 1fr !important; gap: 20px !important; }
          .epk-footer { flex-direction: column !important; gap: 8px !important; align-items: flex-start !important; }
          .epk-nav-actions { gap: 8px !important; }
          .epk-nav-artist-btn { padding: 8px 12px !important; font-size: 10px !important; }
        }
      `}</style>

      {/* NAV */}
      <div className="no-print epk-nav" style={{ borderBottom: "1px solid #141414", padding: "14px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, background: "#080808", zIndex: 50 }}>
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <span style={{ fontFamily: "serif", fontSize: 22, color: "#fff", fontWeight: 900, letterSpacing: "-0.5px" }}>GNS</span>
          <span className="epk-nav-divider" style={{ width: 1, height: 16, background: "#2a2a2a", display: "inline-block" }} />
          <span className="epk-nav-label" style={{ fontSize: 9, letterSpacing: 3, color: "#444", textTransform: "uppercase" }}>Good Natured Souls</span>
        </a>
        <div className="epk-nav-actions" style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <PrintButton />
          <a href={`/artists/${slug}`} className="epk-nav-artist-btn" style={{ background: "none", border: "1px solid #2a2a2a", color: "#666", padding: "9px 20px", fontSize: 11, letterSpacing: 2, textDecoration: "none", textTransform: "uppercase", whiteSpace: "nowrap" }}>
            Artist Page ↗
          </a>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #141414", background: "#0a0a0a" }}>
        <div className="epk-hero-pad" style={{ maxWidth: 960, margin: "0 auto", padding: "64px 40px 56px" }}>
          <div className="epk-hero" style={{ display: "flex", gap: 48, alignItems: "flex-start" }}>

            {artist.profileImage && (
              <div style={{ flexShrink: 0 }}>
                <div className="epk-hero-photo" style={{ width: 200, height: 200, overflow: "hidden", border: "1px solid #1e1e1e" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <h1 className="epk-hero-name" style={{ fontSize: "clamp(36px, 6vw, 64px)", fontWeight: 900, margin: "0 0 6px", letterSpacing: "-2px", lineHeight: 0.95, color: "#fff" }}>
                {artist.name}
              </h1>
      ...
      {/* MAIN */}
      <div className="epk-main-pad" style={{ maxWidth: 960, margin: "0 auto", padding: "56px 40px 80px" }}>

        {/* Press quote */}
        {epk?.pressQuote && (
          <div style={{ marginBottom: 56, borderLeft: "3px solid #F0B51E", paddingLeft: 24 }}>
            <p style={{ fontSize: "clamp(15px, 2.5vw, 22px)", fontStyle: "italic", color: "#ddd", lineHeight: 1.6, margin: "0 0 10px", fontWeight: 300 }}>
              "{epk.pressQuote}"
            </p>
        ...
        {(epk?.bio || artist.about) && (
          <div className="epk-divider">
            <span className="epk-section-label">Biography</span>
        ...
        {hasMusic && (
          <div className="epk-divider">
            <span className="epk-section-label">Music</span>
        ...
        {hasProjects && (
          <div className="epk-divider">
            <span className="epk-section-label">Discography</span>
        ...
        {hasVideos && (
          <div className="epk-divider">
            <span className="epk-section-label">Performances & Videos</span>
        ...
        {epk?.pressPhotos?.length > 0 && (
          <div className="epk-divider">
            <span className="epk-section-label">Press Photos</span>
            ...
            <p style={{ fontSize: 10, color: "#444", marginTop: 12, letterSpacing: 1 }}>
              High-res photos available on request — {epk?.pressEmail || "press@goodnaturedsouls.com"}
            </p>
          </div>
        )}
        ...
        {hasSocial && (
          <div className="epk-divider">
            <span className="epk-section-label">Social Media</span>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        ...
        {/* CONTACT */}
        <div className="epk-divider">
          <span className="epk-section-label">Contact</span>
          <div className="epk-contact-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 28 }}>

            <div style={{ borderLeft: "2px solid #F0B51E", paddingLeft: 16 }}>
              <p style={{ fontSize: 9, letterSpacing: 3, color: "#F0B51E", textTransform: "uppercase", margin: "0 0 8px" }}>Booking</p>
              <a href={`mailto:${epk?.bookingEmail || "booking@goodnaturedsouls.com"}`}
                style={{ fontSize: 13, color: "#fff", textDecoration: "none", display: "block", wordBreak: "break-all" }}>
            ...
            {epk?.pressEmail && (
              <div style={{ borderLeft: "2px solid #2a2a2a", paddingLeft: 16 }}>
                <p style={{ fontSize: 9, letterSpacing: 3, color: "#555", textTransform: "uppercase", margin: "0 0 8px" }}>Press</p>
                <a href={`mailto:${epk.pressEmail}`} style={{ fontSize: 13, color: "#aaa", textDecoration: "none", display: "block", wordBreak: "break-all" }}>
                  {epk.pressEmail}
                </a>
              </div>
            )}
            ...
            <div style={{ borderLeft: "2px solid #2a2a2a", paddingLeft: 16 }}>
              <p style={{ fontSize: 9, letterSpacing: 3, color: "#555", textTransform: "uppercase", margin: "0 0 8px" }}>Label</p>
              <a href="https://goodnaturedsouls.com" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "#aaa", textDecoration: "none", display: "block", marginBottom: 4 }}>
                goodnaturedsouls.com
              </a>
              <span style={{ fontSize: 11, color: "#333", display: "block" }}>Good Natured Souls</span>
            </div>

            {epk?.website && (
              <div style={{ borderLeft: "2px solid #2a2a2a", paddingLeft: 16 }}>
                <p style={{ fontSize: 9, letterSpacing: 3, color: "#555", textTransform: "uppercase", margin: "0 0 8px" }}>Website</p>
                <a href={epk.website.startsWith("http") ? epk.website : `https://${epk.website}`}
                  target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "#aaa", textDecoration: "none", wordBreak: "break-all" }}>
                  {epk.website}
                </a>
              </div>
            )}
        ...
        {/* FOOTER */}
        <div className="epk-footer" style={{ borderTop: "1px solid #141414", paddingTop: 28, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
